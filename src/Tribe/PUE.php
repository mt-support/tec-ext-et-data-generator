<?php
/**
 * Handles the update functionality of this plugin.
 *
 * @since 1.0.0
 *
...
class PUE extends \tad_DI52_ServiceProvider {
	 ...
	 * @var string
	 */
	private static $pue_slug = 'extension-et-test-data-generator';
	 ...
	 * @var string
	 */
	private $update_url = 'http://evnt.is/';
	...
	public function register() {
		...
		$this->container->singleton( 'extension.et_test_data_generator.pue', $this );
