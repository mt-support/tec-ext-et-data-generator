...
class Plugin extends Service_Provider {
	 ...
	 * @var string
	 */
	const SLUG = 'et-test-data-generator';
	 ...
	 * @var string
	 */
	const FILE = TEC_EXTENSION_ET_TEST_DATA_GENERATOR_FILE;
	...
	public function register() {
		...
		$this->container->singleton( 'extension.et_test_data_generator', $this );
		$this->container->singleton( 'extension.et_test_data_generator.plugin', $this );
	...
	protected function register_plugin_dependencies() {
		...
		$this->container->singleton( 'extension.et_test_data_generator', $plugin_register );
	}
}
